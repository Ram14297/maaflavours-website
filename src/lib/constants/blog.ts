...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "heading", level: 2, text: "3. Dosa → Lemon Pickle" },
      { type: "paragraph", text: "Plain dosa — no sambar, no chutney — with lemon pickle on the side is a breakfast Andhra people have eaten for generations. The pickle's bright, tangy sourness cuts through the crispy dosa beautifully. Tear a piece of dosa, scoop a small amount of lemon pickle, fold, eat. That's breakfast." },
