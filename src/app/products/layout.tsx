...
export const metadata: Metadata = {
  ...
  description:
    "Shop authentic Andhra homemade pickles. Drumstick, Gongura, Lemon, Amla, Red Chilli — handcrafted with no preservatives. Pan-India delivery. Free shipping above ₹899.",
};
