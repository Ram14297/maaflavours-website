          ...
          <div className="flex items-end justify-between">
            <div>
              ...
              <div className="flex sm:hidden items-center gap-1.5 flex-wrap">
                <span className="font-dm-sans font-bold text-base leading-none" style={{ color: "var(--color-crimson)" }}>
                  {formatPrice(selectedVariant.price)}
                </span>
                {selectedVariant.compare_at_price && (
                  <span className="font-dm-sans text-xs line-through leading-none" style={{ color: "var(--color-grey)" }}>
                    {formatPrice(selectedVariant.compare_at_price)}
                  </span>
                )}
                {selectedVariant.compare_at_price && (
              ...
              {/* Desktop/Tablet: original two-row layout */}
              <div className="hidden sm:block">
                <div className="flex items-baseline gap-2">
                  <span className="font-dm-sans font-bold text-lg leading-none" style={{ color: "var(--color-crimson)" }}>
                    {formatPrice(selectedVariant.price)}
                  </span>
                  {selectedVariant.compare_at_price && (
                    <span className="font-dm-sans text-sm line-through leading-none" style={{ color: "var(--color-grey)" }}>
                      {formatPrice(selectedVariant.compare_at_price)}
                    </span>
                  )}
                </div>
