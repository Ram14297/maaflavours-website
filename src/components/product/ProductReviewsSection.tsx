...
const SEED_REVIEWS: Record<string, Review[]> = {
  "drumstick-pickle": [
    {
      ...
      body: "I've been searching for a drumstick pickle that tastes like my grandmother's recipe. Maa Flavours nailed it — the spice balance is perfect, the oil is fragrant, and the texture of the drumstick pieces is spot on. Already on my third jar!",
      verified: true,
      helpful: 12,
      date: "2025-01-15",
    },
  ...
  "default": [
    ...
    },
    {
      ...
      body: "Been ordering from multiple online pickle brands. Maa Flavours is hands down the best. Gifted 3 jars to relatives and they all want to know where to order more.",
      verified: true,
      helpful: 15,
      date: "2025-02-05",
    },
