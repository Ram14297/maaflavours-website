...
// 4 columns: Logo+tagline | Shop | Policies | Contact
// Social links, FSSAI note, vegetarian badge, WhatsApp float button
        ...
        <div className="section-container pt-14 pb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <Link href="/" className="inline-flex items-center gap-2.5 group mb-4">
                ...
                <div className="flex flex-col leading-none">
                  ...
                  <span
                    className="font-dancing text-xs"
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3.5">
                <li>
                  ...
                  >
                    <Phone
                      size={15}
                      className="mt-0.5 flex-shrink-0 group-hover:text-gold transition-colors"
              ...
              {/* WhatsApp CTA */}
              <a
                href={`https://wa.me/${SITE.whatsapp}?text=Hi! I'd like to order Maa Flavours pickles.`}
                target="_blank"
                rel="noopener noreferrer"
